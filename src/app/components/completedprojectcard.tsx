...
const CompletedProjectcard: React.FC<ProjectcardProps> = ({ index, companyName, projects, logo,folderName }) => {
    return (
                ...
                <div key={index} className="w-full h-full flex flex-col space-y-2 " >
                    <div className='w-full h-[100px]  flex items-center justify-center'>
                        <div className='w-[40%] xl:w-[30%] lg:w-[28%] md:w-[25%] sm:w-[25%] h-[50%] xl:h-[80%] lg:h-[70%] md:h-[60%] sm:h-[60%] relative max-h-[80%]'>
                            <Image src={`/completed-projects/${folderName}/${logo}`} alt="companylogo" fill className='object-fill' />
                        </div>
                            ...
                            >
                                <div className="w-full h-[80%] flex items-center justify-center ">
                                    <div className="relative w-full h-full max-h-[200px] xl:max-h-[240px] lg:max-h-[220px] md:max-h-[200px]">
                                        <Image
                                            src={`/completed-projects/${folderName}/${project.image}`}
                                            alt={project.title}
                                            fill
