...
export const completedProjects: CompanyProjects[] = [
    {
        ...
        folder : "TROJAN CONSTRUCTION GROUP",
        logo:"logo.png",
        projects: [
          { image: "img 1.png", title: "AL MARYAH VISTA 1&2" },
          { image: "img 2.png", title: "LANDSCAPING (IMPERIAL 3&4)" },
          { image: "img 3.png", title: "COMMUNITY PARK" },
          { image: "img 4.png", title: "DAMAC MERANO TOWER" },
         ],
    },
    {
        company: "Royal Ritz INTERIORS & MEP",
        folder : "Royal Ritz INTERIORS & MEP",
        logo:"logo.png",
        projects: [
           { image: "img 1.png", title: "Sheikh Zayed Cricket Stadium" },
           { image: "img 2.png", title: "Palm Jumeirah Villa Project" },
       ],
    },
    {
        company: "MAG international electromechanical works",
        folder : "MAG international electromechanical works",
        logo:"logo.png",
        projects: [
             { image: "img 1.png", title: "INTERNATIONAL TOWER" },
             { image: "img 2.png", title: "LAGOON VILLAS" },
             { image: "img 3.png", title: "DUBAI CREEK" },
             { image: "img 4.png", title: "SKYCOURTS TOWER" },
             { image: "img 5.png", title: "LANDMARK VIEWS RESIDENTIAL COMPLEX" },
         ],
    },
    {
        company: "Gesco Ginco electrical & Sanitary contacting Co. LLC",
        folder : "Gesco Ginco electrical & Sanitary contacting Co. LLC",
        logo:"logo.png",
        projects: [
           { image: "img 1.png", title: "Sharjah Oasis Mall" },
           { image: "img 2.png", title: "Maryam Island Development" },
       ],
    },
    {
        company: "Almoayyed Electromechanical Contracting",
        folder : "Almoayyed Electromechanical Contracting",
        logo:"logo.png",
       projects: [
           { image: "img 1.png", title: "AL Wasal-Qusaia." },
       ],
    },
...
export const ongoingProjects: CompanyProjects[] = [
    ...
    },
    {
        ...
        projects: [
            ...
            { image: "img3.jpeg", title: "Athlon by Aldar Package 1, 2 & 3 (1,492 Villas)" },
